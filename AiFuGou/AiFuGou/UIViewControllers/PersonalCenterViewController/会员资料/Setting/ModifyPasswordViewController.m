...
@end@implementation ModifyPasswordViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
    self.title = @"修改密码";
...
{
    __weak ModifyPasswordViewController *regViewController = self;
...
{
    NewPasswordViewController *vc = [NewPasswordViewController new];
...
//    self.getCodeButton.layer.borderColor = [UIColor yellowColor].CGColor;
