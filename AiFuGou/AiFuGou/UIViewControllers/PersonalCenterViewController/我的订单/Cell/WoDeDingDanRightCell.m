...
@interface WoDeDingDanRightCell()
...
@end
@implementation WoDeDingDanRightCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self == [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.titleDetailLabel.text = @"等待买家付款";
        ...
        [self.shouHuoButton setTitle:@"付款" forState:UIControlStateNormal];
