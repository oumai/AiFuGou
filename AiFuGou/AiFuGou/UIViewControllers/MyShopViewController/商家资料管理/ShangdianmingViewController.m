...
//
//  ShangdianmingViewController.m
//  AIFUGOU
//
//  Created by Minghui Sun on 16/5/21.
//  Copyright © 2016年 Leaves. All rights reserved.
//
#import "Masonry.h"
#import "ShangdianmingViewController.h"
@interface ShangdianmingViewController ()
...
@implementation ShangdianmingViewController
...
- (void)viewDidLoad {
    ...
    self.textField.placeholder = @"请填写商户名";
    ...
    [_textField mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.equalTo(self.cellView.mas_right).offset(-10);
